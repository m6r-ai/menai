...
class TestMoveU:
    ...
    def test_move_u_preserves_d_face(self, menai):
        ...
        expr = _rubiks_expr(
            '(let ((cube ((rubiks solved-cube))))'
            '  (let ((moved ((rubiks apply-move) cube "U")))'
            '    (struct-get moved \'D)))'
        )
    ...
    def test_move_u_four_times_identity(self, menai):
        ...
        expr = _rubiks_expr(
            '(let ((cube ((rubiks solved-cube))))'
            '  (let ((m1 ((rubiks apply-move) cube "U")))'
            '    (let ((m2 ((rubiks apply-move) m1 "U")))'
            '      (let ((m3 ((rubiks apply-move) m2 "U")))'
            '        (let ((m4 ((rubiks apply-move) m3 "U")))'
            '          ((rubiks cube-solved?) m4))))))'
        )
        assert menai.evaluate(expr) is True
...
class TestMoveD:
    ...
    def test_move_d_preserves_u_face(self, menai):
        ...
        expr = _rubiks_expr(
            '(let ((cube ((rubiks solved-cube))))'
            '  (let ((moved ((rubiks apply-move) cube "D")))'
            '    (struct-get moved \'U)))'
        )
        assert menai.evaluate(expr) == [0] * 9
    ...
    def test_move_d_four_times_identity(self, menai):
        ...
        expr = _rubiks_expr(
            '(let ((cube ((rubiks solved-cube))))'
            '  (let ((m1 ((rubiks apply-move) cube "D")))'
            '    (let ((m2 ((rubiks apply-move) m1 "D")))'
            '      (let ((m3 ((rubiks apply-move) m2 "D")))'
            '        (let ((m4 ((rubiks apply-move) m3 "D")))'
            '          ((rubiks cube-solved?) m4))))))'
        )
        assert menai.evaluate(expr) is True
...
class TestMoveF:
    ...
    def test_move_f_preserves_b_face(self, menai):
        ...
        expr = _rubiks_expr(
            '(let ((cube ((rubiks solved-cube))))'
            '  (let ((moved ((rubiks apply-move) cube "F")))'
            '    (struct-get moved \'B)))'
        )
    ...
    def test_move_f_four_times_identity(self, menai):
        ...
        expr = _rubiks_expr(
            '(let ((cube ((rubiks solved-cube))))'
            '  (let ((m1 ((rubiks apply-move) cube "F")))'
            '    (let ((m2 ((rubiks apply-move) m1 "F")))'
            '      (let ((m3 ((rubiks apply-move) m2 "F")))'
            '        (let ((m4 ((rubiks apply-move) m3 "F")))'
            '          ((rubiks cube-solved?) m4))))))'
        )
        assert menai.evaluate(expr) is True
...
class TestMoveB:
    ...
    def test_move_b_preserves_f_face(self, menai):
        ...
        expr = _rubiks_expr(
            '(let ((cube ((rubiks solved-cube))))'
            '  (let ((moved ((rubiks apply-move) cube "B")))'
            '    (struct-get moved \'F)))'
        )
    ...
    def test_move_b_four_times_identity(self, menai):
        ...
        expr = _rubiks_expr(
            '(let ((cube ((rubiks solved-cube))))'
            '  (let ((m1 ((rubiks apply-move) cube "B")))'
            '    (let ((m2 ((rubiks apply-move) m1 "B")))'
            '      (let ((m3 ((rubiks apply-move) m2 "B")))'
            '        (let ((m4 ((rubiks apply-move) m3 "B")))'
            '          ((rubiks cube-solved?) m4))))))'
        )
        assert menai.evaluate(expr) is True
...
class TestMoveL:
    ...
    def test_move_l_preserves_r_face(self, menai):
        ...
        expr = _rubiks_expr(
            '(let ((cube ((rubiks solved-cube))))'
            '  (let ((moved ((rubiks apply-move) cube "L")))'
            '    (struct-get moved \'R)))'
        )
    ...
    def test_move_l_four_times_identity(self, menai):
        ...
        expr = _rubiks_expr(
            '(let ((cube ((rubiks solved-cube))))'
            '  (let ((m1 ((rubiks apply-move) cube "L")))'
            '    (let ((m2 ((rubiks apply-move) m1 "L")))'
            '      (let ((m3 ((rubiks apply-move) m2 "L")))'
            '        (let ((m4 ((rubiks apply-move) m3 "L")))'
            '          ((rubiks cube-solved?) m4))))))'
        )
        assert menai.evaluate(expr) is True
...
class TestMoveR:
    ...
    def test_move_r_preserves_l_face(self, menai):
        ...
        expr = _rubiks_expr(
            '(let ((cube ((rubiks solved-cube))))'
            '  (let ((moved ((rubiks apply-move) cube "R")))'
            '    (struct-get moved \'L)))'
        )
    ...
    def test_move_r_four_times_identity(self, menai):
        ...
        expr = _rubiks_expr(
            '(let ((cube ((rubiks solved-cube))))'
            '  (let ((m1 ((rubiks apply-move) cube "R")))'
            '    (let ((m2 ((rubiks apply-move) m1 "R")))'
            '      (let ((m3 ((rubiks apply-move) m2 "R")))'
            '        (let ((m4 ((rubiks apply-move) m3 "R")))'
            '          ((rubiks cube-solved?) m4))))))'
        )
        assert menai.evaluate(expr) is True
...
class TestApplyMove:
    ...
    def test_prime_is_triple(self, menai, move):
        ...
        expr = _rubiks_expr(
            f'(let ((cube ((rubiks solved-cube))))'
            f'  (let ((scrambled ((rubiks apply-move) cube "{move}")))'
            f'    (let ((prime ((rubiks apply-move) scrambled "{move}\'")))'
            f'      ((rubiks cube-solved?) prime))))'
        )
        assert menai.evaluate(expr) is True
    ...
    def test_double_is_pair(self, menai, move):
        ...
        expr = _rubiks_expr(
            f'(let ((cube ((rubiks solved-cube))))'
            f'  (let ((d1 ((rubiks apply-move) cube "{move}2")))'
            f'    (let ((d2 ((rubiks apply-move) d1 "{move}2")))'
            f'      ((rubiks cube-solved?) d2))))'
        )
        assert menai.evaluate(expr) is True
    ...
    def test_unknown_move_returns_cube_unchanged(self, menai):
        ...
        expr = _rubiks_expr(
            '(let ((cube ((rubiks solved-cube))))'
            '  (let ((moved ((rubiks apply-move) cube "XYZ")))'
            '    ((rubiks cube-solved?) moved)))'
        )
        assert menai.evaluate(expr) is True
...
class TestApplyMoves:
    ...
    def test_empty_moves_returns_cube(self, menai):
        ...
        expr = _rubiks_expr(
            '(let ((cube ((rubiks solved-cube))))'
            '  (let ((moved ((rubiks apply-moves) cube (list))))'
            '    ((rubiks cube-solved?) moved)))'
        )
        assert menai.evaluate(expr) is True
    ...
    def test_scramble_not_solved(self, menai, name, moves):
        ...
        expr = _rubiks_expr(
            '(let ((cube ((rubiks solved-cube))))'
            f'  (let ((scrambled ((rubiks apply-moves) cube {moves_lit})))'
            '    ((rubiks cube-solved?) scrambled)))'
        )
...
class TestCubeSolved:
    ...
    def test_solved_cube_is_solved(self, menai):
        ...
        expr = _rubiks_expr(
            '((rubiks cube-solved?) ((rubiks solved-cube)))'
        )
        assert menai.evaluate(expr) is True
...
class TestHeuristic:
    ...
    def test_solved_cube_heuristic_zero(self, menai):
        ...
        expr = _rubiks_expr(
            '((rubiks heuristic) ((rubiks solved-cube)))'
        )
...
class TestIdaStar:
    ...
    def test_solved_cube_found_immediately(self, menai):
        ...
        expr = _rubiks_expr(
            '(let ((cube ((rubiks solved-cube))))'
            '  (let ((result ((rubiks ida-star) cube 20)))'
    ...
    def test_solution_actually_solves(self, menai, name, moves):
        ...
        expr = _rubiks_expr(
            ...
            '      (apply-moves-fn (rubiks apply-moves))'
            '      (ida-star-fn (rubiks ida-star))'
            '      (cube-solved-fn (rubiks cube-solved?)))'
            f'  (let ((scrambled (apply-moves-fn (solved-cube-fn) {moves_lit})))'
            '    (let ((result (ida-star-fn scrambled 20)))'
...
class TestPrintCube:
    ...
    def test_solved_cube_print(self, menai):
        ...
        expr = _rubiks_expr(
            '((rubiks print-cube) ((rubiks solved-cube)))'
        )
        result = menai.evaluate(expr)
...
class TestFormatSolution:
    ...
    def test_format_found(self, menai):
        ...
        expr = _rubiks_expr(
            ...
            '      (apply-moves-fn (rubiks apply-moves))'
            '      (ida-star-fn (rubiks ida-star))'
            '      (format-fn (rubiks format-solution)))'
...
class TestMoveCombinations:
    ...
    def test_move_then_inverse_solves(self, menai, move):
        ...
        expr = _rubiks_expr(
            '(let ((cube ((rubiks solved-cube))))'
            f'  (let ((m1 ((rubiks apply-move) cube "{move}")))'
            f'    (let ((m2 ((rubiks apply-move) m1 "{inverse}")))'
            '      ((rubiks cube-solved?) m2))))'
        )
        assert menai.evaluate(expr) is True
    ...
    def test_u_d_commute(self, menai):
        ...
        expr = _rubiks_expr(
            '(let ((cube ((rubiks solved-cube))))'
            '  (let ((ud ((rubiks apply-moves) cube (list "U" "D"))))'
            '    (let ((du ((rubiks apply-moves) cube (list "D" "U"))))'
