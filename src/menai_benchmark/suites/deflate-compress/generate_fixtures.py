"""
Generate the raw input fixture files used by the deflate-compress benchmark suite.
...
Run from the repository root:
    ...
    python src/menai_benchmark/suites/deflate-compress/generate_fixtures.py
