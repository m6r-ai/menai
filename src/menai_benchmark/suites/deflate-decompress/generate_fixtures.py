"""
Generate the raw DEFLATE fixture files used by the deflate-decompress benchmark suite.
...
Run from the repository root:
    ...
    python src/menai_benchmark/suites/deflate-decompress/generate_fixtures.py
