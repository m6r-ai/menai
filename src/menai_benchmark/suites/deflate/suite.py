...
_EXPR = '(let ((deflate (import "deflate"))) ((dict-get deflate "deflate") input-data))'
...
class Suite(BenchmarkSuite):
    ...
    def implementation(self, menai: Menai) -> Implementation:
        """Return the Menai deflate implementation."""
        def prepare_menai(fixture_path: Path) -> Any:
            """Compile the deflate expression and bind the fixture bytes (untimed)."""
