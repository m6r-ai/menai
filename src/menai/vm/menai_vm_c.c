             ...
             MenaiValue **regs, int max_locals, MenaiVMError *out_error, int *cancel_flag)
{
    ...
    while (1) {
        ...
        case OP_STRING_CONCAT: {
            ...
            MenaiString *r = menai_string_alloc(a->length + b->length);
            if (r == NULL) {
                goto error;
            }
        ...
        case OP_STRING_SLICE: {
            ...
            MenaiString *r = menai_string_alloc(len);
            if (r == NULL) {
                goto error;
            }
            ...
            if (blen == 0) {
                ...
                for (ssize_t i = 0; i <= alen; ) {
                    ...
                    if (match || i == alen) {
                        ...
                        MenaiString *p = menai_string_alloc(seg_len);
                        if (!p) {
        ...
        case OP_BYTES_TO_STRING: {
            ...
            MenaiString *result = menai_string_alloc(ncp);
            if (result == NULL) {
                free(cp_buf);
                goto error;
            }
        ...
        case OP_BYTES_TO_STRING_HEX: {
            ...
            MenaiString *result = menai_string_alloc(nbytes * 2);
            if (result == NULL) {
                free(cp_buf);
                goto error;
            }
...
#undef BYTES_WRITE_MULTI
        ...
        case OP_LIST_TO_STRING: {
            ...
            MenaiString *r = menai_string_alloc(total);
            if (r == NULL) {
                free(lts_buf);
                goto error;
            }
