...
class VMErrorCode(IntEnum):
    ...
    NOT_SYMBOL_PAIR = -102
    IF_NOT_BOOLEAN = -103
    ERROR_MSG_NOT_STRING = -104
    NOT_CALLABLE = -105
    APPLY_SECOND_NOT_LIST = -106
    APPLY_FIRST_NOT_FUNCTION = -107
    PATCH_CLOSURE_NOT_FUNCTION = -108
    INDEX_NOT_INTEGER = -109
    SLICE_INDICES_NOT_INTEGER = -110
    NOT_SINGLE_CHAR_STRING = -111
    RADIX_NOT_INTEGER = -112
    OFFSET_NOT_INTEGER = -113
    VALUE_NOT_INTEGER = -114
    LIST_ELEMENTS_NOT_INTEGERS = -115
    SLICE_START_NOT_INTEGER = -116
    SLICE_END_NOT_INTEGER = -117
    BYTE_NOT_INTEGER = -118
    LIST_TO_STRING_NOT_STRINGS = -119
    RANGE_NOT_INTEGER = -120
    STRUCT_FIRST_NOT_TYPE = -121
    INDEX_OUT_OF_RANGE = -122
    SLICE_START_OUT_OF_RANGE = -123
    SLICE_END_OUT_OF_RANGE = -124
    OFFSET_OUT_OF_BOUNDS = -125
    DIVISION_BY_ZERO = -126
    MODULO_BY_ZERO = -127
    INVALID_RADIX = -128
    VALUE_OUT_OF_RANGE = -129
    INVALID_CODEPOINT = -130
    NEGATIVE_SLICE_INDEX = -131
    NEGATIVE_EXPONENT = -132
    NEGATIVE_SHIFT = -133
    NEGATIVE_ARGUMENT = -134
    SHIFT_TOO_LARGE = -135
    INVALID_LOG_BASE = -136
    SLICE_START_AFTER_END = -137
    ARITY_MISMATCH = -138
    STRUCT_ARITY_MISMATCH = -139
    UNDEFINED_VARIABLE = -140
    STRUCT_FIELD_NOT_FOUND = -141
    EMPTY_LIST = -142
    CALL_DEPTH_EXCEEDED = -143
    UNHASHABLE_KEY = -144
    INVALID_UTF8 = -145
    HEX_EVEN_LENGTH = -146
    INVALID_HEX_CHAR = -147
    TRUNCATED_LEB128 = -148
    RANGE_ZERO_STEP = -149
    CLOSURE_INDEX_OUT_OF_RANGE = -150
    MISSING_RETURN = -151
    UNIMPLEMENTED_OPCODE = -152
    USER_ERROR = -153
...
_ERROR_TABLE: dict[VMErrorCode, _ErrorTableEntry] = {
    ...
    VMErrorCode.DIVZERO: (ZeroDivisionError, "division by zero", None),
