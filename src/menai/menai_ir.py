...
class MenaiIRLambda:
    ...
    free_var_plans: List['MenaiIRVariable']  # Plans for loading free variables
    param_count: int
    ...
    parent_ref_plans: List['MenaiIRVariable'] = field(default_factory=list)  # Plans for loading parent references
